 ...
 *  - 'date_picker' : SCENARIO 02.4 출발일+박수 picker (TRIP START 도시 선택 후, D35)
 *  - 'dates'   : SCENARIO 02.5 일자별 날씨 (date_picker 확정 후, D33)
 ...
 */
export type TripPlanningStep = 'date_picker' | 'dates' | 'pois' | 'routes' | 'on_trip'
